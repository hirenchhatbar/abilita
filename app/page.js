    ...
    <section>
      <div className="container-fluid px-lg-0 px-xl-0 my-5">
        ...
        <div className="container d-flex justify-content-center flex-column">
          <p className="mb-4">
            Greetings! I am Hiren, a Technical Architect specialized in PHP and
            JavaScript. My approach is to keep things simple, straightforward,
            and efficient. I have a particular fondness for Linux and strive to
            enhance my problem-solving skills every day.
          </p>
          <p className="mb-4">
            ...
            contact form submissions. Since then, I have grown into a passionate
            and tech-savvy senior web developer. Presently, I focus on
            developing web applications, portals, and REST APIs for various
            clients at Weignyte.
          </p>
          <p>
            Learning is an integral part of my professional journey, and I
            strive to learn, unlearn and relearn every day to stay updated with
            the latest trends and technologies. Apart from my professional life,
            I am an avid nature enthusiast and find peace in practicing yoga. I
            also have a keen interest in music, movies, cricket, reading,
